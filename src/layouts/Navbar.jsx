...
const Navbar = () => {  
    ...
    return (                      
        <nav className='flex items-center w-[99.5%] max-w-full h-[50px] left-1 fixed top-6 py-7 bg-slate-950 z-50 bg-opacity-80 hover:text-zinc-900 border-2 border-dotted border-zinc-300'> 
            <div className="flex w-full justify-between items-center">
                <div className="flex w-[14%] items-center bg-purple-500 justify-end pr-10 py-2">
                    <div className="flex w-2 h-4 bg-electro-300 mr-3"></div>
                    <p className='text-slate-950 font-ibm text-[1.5rem] font-[500] uppercase tracking-widest'>
                    ...
                    <div className='flex w-full justify-between center items-center'>           
                        <ul className='w-full flex justify-between items-center bg-transparent'>
                            {['about', 'projects', 'resume', 'contact'].map((item, index) => (
                                <li className='text-zinc-300 font-ibm text-[2.3rem] font-[300] 
